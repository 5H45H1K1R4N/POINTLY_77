...
data class ProfileEntity(
    ...
    val className: String = "Class 8",
    val section: String = "A",
    val school: String = "Bento International School",
    val board: String = "CBSE",
    val bio: String = "Excelsior! Curious mind dedicated to constant learning and gamified focus.",
    val joinDate: String = "July 17, 2026",
    val totalStudyHours: Float = 58.0f,
    val profileImage: String = "https://api.dicebear.com/7.x/adventurer/svg?seed=Quest",
    val privacySetting: String = "Public", // Public, School Only, Friends Only, Private
    val visibleAchievements: Boolean = true,
    val visiblePortfolio: Boolean = true,
    val visibleShowcase: Boolean = true,
    val visibleStatistics: Boolean = true,
    val followersCount: Int = 24,
    val followingCount: Int = 18,
    // Phase 6 Skills (0.0 to 1.0 representing percentage)
    val mathSkill: Float = 0.85f,
    val scienceSkill: Float = 0.78f,
    val englishSkill: Float = 0.92f,
    val codingSkill: Float = 0.65f,
    val commSkill: Float = 0.80f,
    val creativitySkill: Float = 0.74f,
    val leadershipSkill: Float = 0.60f,
    val problemSolvingSkill: Float = 0.82f,
